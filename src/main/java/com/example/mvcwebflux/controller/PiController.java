...
public class PiController {
    ...
    public String calculatePi(@RequestParam(defaultValue = "10000") int digits) {
        if (digits <= 0 || digits > 100000) { // Ограничение на разумный диапазон
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "Number of digits must be between 1 and 100,000");
        }
